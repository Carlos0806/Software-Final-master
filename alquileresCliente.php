...
<head>
	...
	<title>Vehiler - Alquileres</title>
<!--
Holiday Template
...
<body>
	...
	<!-- Table -->
								<section class="box">
									...
									<br>
									<div class="table-wrapper" id="tablaAlquileresHist">
								...
								<section class="box">
									...
									<br>
									<div class="table-wrapper" id="tablaAlquileres">
								...
								<a name="modificacionAlquiler"><section class="box"></a>
									...
									<form method="get" action="#">
										<div class="row uniform 50%">
											...
											<input id="userMod" type="hidden" class="form-control" value="<?php echo $_SESSION['s_user']; ?>">
											</input>
